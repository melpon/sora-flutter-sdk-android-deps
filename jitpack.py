...
def main():
    source_dir = os.path.join(PROJECT_DIR, '_source')
    install_dir = os.path.join(PROJECT_DIR, '_install', 'windows_x86_64')
    mkdir_p(source_dir)
    mkdir_p(install_dir)
    install_sora('2022.12.1', source_dir, install_dir, 'windows_x86_64')
    cmd('mvn', 'install:install-file', '_install/windows_x86_64/sora/lib/sora.lib')
